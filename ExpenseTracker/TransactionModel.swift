...
extension Category{
    ...
    static let financeCharge = Category(id: 402, name: "Finance Charges", icon: .hand_holding_usd, mainCategoryId: 4)
    static let groceries = Category(id: 501, name: "Groceries", icon: .shopping_basket, mainCategoryId: 5)
    static let restaurent = Category(id: 502, name: "Restaurant", icon: .utensils, mainCategoryId: 5)
